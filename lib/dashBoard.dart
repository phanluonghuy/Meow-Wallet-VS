            ...
            child: Column(
              ...
              children: [
                Container(
                    ...
                    child: Image.network('https://upload.wikimedia.org/wikipedia/commons/1/12/230601_Karina_%28aespa%29.jpg',fit: BoxFit.cover)
                ),
                SizedBox(height: 10,),
                Padding(
                  padding: EdgeInsets.only(left: 30.0),
                  child: Text(userDAO.username,
                    style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600),),
                ),
                Spacer(),
                Padding(
                  padding: EdgeInsets.only(left:20,bottom: 30.0),
                  child: Text("MEOW WALLET🐱‍🚀",
